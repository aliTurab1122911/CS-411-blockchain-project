...
// external addition for debugging
const loadBlockchainData = async () => {
  try {
    ...
    if (!realEstateAddress || !escrowAddress) {
      console.error("Contract addresses are not configured for this network.");
      return;
    }

    const realEstate = new ethers.Contract(realEstateAddress, RealEstate, provider);
    console.log("RealEstate contract instance:", realEstate);
    ...
    for (var i = 1; i <= totalSupply; i++) {
      ...
      console.log(`Token URI for ${i}:`, uri);
